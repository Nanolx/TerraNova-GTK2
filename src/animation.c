...
/* This code is responsible for the terranova animation support. The code
...
{
	if (TN_IS_ANI_PROGRESS_BAR (widget))
...
/* helper function for terranova_animation_connect_checkbox */
static gint
...
/* adds a progress bar */
void
terranova_animation_progressbar_add (GtkWidget *progressbar)
{
...
void
terranova_animation_connect_checkbox (GtkWidget *widget)
{
	if (TN_IS_CHECK_BUTTON (widget))
	{
...
gboolean
terranova_animation_is_animated (GtkWidget *widget)
{
...
gdouble
terranova_animation_elapsed (gpointer data)
{
